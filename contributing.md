# Contributing to gulp-paginationator

First and foremost, thank you! We appreciate that you want to contribute to gulp-paginationator, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for gulp-paginationator**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for gulp-paginationator:

- star the [project](https://github.com/doowb/gulp-paginationator)
- tweet your support for gulp-paginationator
...
- **version**: please note the version of gulp-paginationator are you using
...
[so]: http://stackoverflow.com/questions/tagged/gulp-paginationator